...
The critique will be conducted on the website( <https://www.dji.com/>) from three aspects: **Usability**, **Visual Hierarchy** and **Mobile Friendliness**.
...
- However, there is not social links in the navigation, but put it at the bottom of the website.  Maybe it's because the website hopes to retain visitors without being diverted by social media.
...
- However, the text of primary navigation, secondary navigation and tertiary navigation is a bit small. This will give users a sense of inconsistent proportions.

## Visual Hierarchy

**Overall**
The overall impression the homepage is brief and generous and is opened quickly even if there are a lot of pictures on the homepage. As a professional manufacturer of drones and sports shooting equipment, DJI's products have good industrial design, so using pictures to convey product information can quickly catch users' eyes.

**Content Scannable**
- The content scannable is very good, even though the designer does not use the **Z-Pattern** layout or **zig-zag pattern** layout.

- Due to the symmetrical layout of the page, visitors will use top-to-bottom scanning. At the same time, DJI puts the most important content on the first and second screens.  designer does not want users to scan web pages, but rather want users to see what they get when they open the homepage.
...
- However, the text of pages does not use left alignment but uses a center alignment mode. The website have abandoned the F pattern ideas, so it adopted this alignment.
